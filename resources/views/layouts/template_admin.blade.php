        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
          ...
          <div class="d-flex align-items-center">
            <div class="toggle-icon-wrapper">
              ...
              <div class="d-flex align-items-center py-3"><img class="me-2" src="{{ $ruta }}../resources/assets/img/icons/bitacora_almacen_blue.png" alt="" width="40" /><span class="font-sans-serif">{{ config('app.name') }}</span>
              </div>
            </a>
          </div>
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="usuarios">
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.users_index') }}" data-bs-toggle="" aria-expanded="false">
                  ...
                  <!-- parent pages-->
                  <a class="nav-link" href="{{ route('admin.grupos') }}" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">Grupos</span>
                    </div>
                  </a>
                  
                  <!-- parent pages-->
                  <a class="nav-link" href="{{ route('admin.server_ldap') }}" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="far fa-address-card"></span></span><span class="nav-link-text ps-1">LDAP</span>
                    </div>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="herramientas">
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.entregas') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                          <span class="nav-link-icon">
        ...
        <div class="content">
          ...
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <a class="navbar-brand me-1 me-sm-3" >
              <div class="d-flex align-items-center"><img class="me-2" src="{{ $ruta }}../resources/assets/img/favicons/mstile-150x150.png" alt="" width="30" /><span class="font-sans-serif">{{ config('app.name') }}</span>
              </div>
            </a>
            ...
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="avatar avatar-xl">
                    ...
                    @else
                      <img class="rounded-circle" src="{{$ruta}}../storage/app/avatars/avatar.svg" alt="" /> 
                    @endif
                  </div>
                </a>
