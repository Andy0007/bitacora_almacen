    ...
    <div class="table-responsive scrollbar">
      <table class="table table-bordered table-striped fs--2 mb-0">
        <thead class="bg-500 text-900">
          <tr>
            <th class="text-center sort" data-sort="numero">N°</th>
            <th class="text-center sort" data-sort="grupo">Grupo</th>
            <th class="text-center sort" data-sort="descripcion">Descripción</th>
            <th class="text-center sort" data-sort="descripcion">Estatus</th>
        ...
        <tbody class="list">
            ...
            @php
                if ($row->status == 'activo') {
                    $btn = 'btn btn-small btn-success center-block';
                } else {
                    $btn = 'btn btn-danger center-block';
                }
            ...
            <tr>
                ...
                <td class="text-center">
                    <button class="{{ $btn }}"> {{ $row->status }} </button>
                </td>
                <td class="text-center">
